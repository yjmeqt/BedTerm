...
//!
//! This is extracted from bedterm-ios/build.rs so the pure-logic `l10n`
//! module can live in `bedterm-app`.
...
fn main() {
    ...
    // sits at rust-core/bedterm-app/ — walk up two parents.
    ...
    println!(
        "cargo:warning=bedterm_app l10n: parsed {} keys across {} locales",
